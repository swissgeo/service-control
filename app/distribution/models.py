...
class Distribution(PolymorphicModel):
    ...
    dataset = models.ForeignKey("dataset.Dataset", on_delete=models.CASCADE, null=True)
    collection = models.ForeignKey("collection.Collection", on_delete=models.CASCADE, null=True)
