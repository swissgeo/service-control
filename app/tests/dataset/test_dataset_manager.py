...
def test_data_source_ids(db):
    ...
    assert Dataset.objects.existing_data_source_ids(Dataset.DataSource.BOD_DATASET) == {
        "1",
        "2",
        "3",
    }

    assert Dataset.objects.existing_data_source_ids(Dataset.DataSource.USER_INPUT) == {
        "1",
        "2",
        "3",
        "4",
