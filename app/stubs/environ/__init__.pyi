...
class Env:
    ...
    def str(
        self, var: builtins.str, default=..., multiline: builtins.bool = ...
    ) -> builtins.str: ...
    def bool(self, var: builtins.str, default=...) -> builtins.bool: ...
    def int(self, var: builtins.str, default=...) -> builtins.str: ...
    def list(
        self, var, cast: Incomplete | None = None, default=...
    ) -> list[builtins.str | builtins.int]: ...
    def dict(
        self, var, cast=..., default=...
    ) -> dict[builtins.str, builtins.str | builtins.int]: ...
    def json(self, var, default=...) -> builtins.dict[builtins.str, object] | None: ...
