...
@router.put(
    ...
    exclude_none=True,
    auth=vp_auth("updateOrganization"),
)
...
@router.put(
    ...
    exclude_none=True,
    auth=vp_auth("updateUnit", path_var="unit_id"),
)
def update_unit(
    request: HttpRequest,
    organization_id: str,
...
@router.get(
    ...
    response={200: UnitSchema},
    exclude_none=True,
    auth=vp_auth("getUnit", path_var="unit_id"),
)
def unit(
    request: HttpRequest,
    organization_id: str,
...
@router.delete(
    "/organizations/{organization_id}/units/{unit_id}",
    response={204: None},
    auth=vp_auth("deleteUnit", path_var="unit_id"),
)
def delete_unit(
